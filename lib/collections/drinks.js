...
Meteor.methods({
  ...
  upvote: function(drinkId) {
    ...
    if (!drink)
      throw new Meteor.Error('invalid', 'Drink not found');
    if (_.include(drink.upvoters, this.userId))
      throw new Meteor.Error('invalid', 'Already upvoted this drink');

    Drinks.update(drink._id, {
